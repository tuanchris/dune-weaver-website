...
export default function DWPProGallery({ images }: Props) {
              ...
              {images.map((image) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-sand-600">DWP Pro</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-sand-500">
                  Add images to <code className="px-2 py-1 bg-sand-100 rounded text-sm">public/gallery/dwp-pro/</code> and rebuild
                </p>
              </div>
            </div>
          )}
