...
export default function OGDWGallery({ images }: Props) {
              ...
              {images.map((image) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-sand-300">OG DW</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-sand-400">
                  Add images to <code className="px-2 py-1 bg-sand-800 rounded text-sm">public/gallery/og-dw/</code> and rebuild
                </p>
              </div>
            </div>
          )}
